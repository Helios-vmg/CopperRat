...
static SDL_Scancode Android_Keycodes[] = {
    ...
    SDL_SCANCODE_ANDROID_AUDIOPLAYPAUSE, /* AKEYCODE_MEDIA_PLAY_PAUSE */
    ...
    SDL_SCANCODE_ANDROID_AUDIOPLAY, /* AKEYCODE_MEDIA_PLAY */
    SDL_SCANCODE_ANDROID_AUDIOPAUSE, /* AKEYCODE_MEDIA_PAUSE */
