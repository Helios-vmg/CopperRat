...
/* Resize */
void Java_org_copper_rat_CopperRat_onNativeResize(
...
// Paddown
int Java_org_copper_rat_CopperRat_onNativePadDown(
                                    JNIEnv* env, jclass jcls,
...
// Padup
int Java_org_copper_rat_CopperRat_onNativePadUp(
                                   JNIEnv* env, jclass jcls,
                                   jint device_id, jint keycode)
{
...
/* Joy */
void Java_org_copper_rat_CopperRat_onNativeJoy(
                                    JNIEnv* env, jclass jcls,
...
/* POV Hat */
void Java_org_copper_rat_CopperRat_onNativeHat(
                                    JNIEnv* env, jclass jcls,
...
int Java_org_copper_rat_CopperRat_nativeAddJoystick(
    JNIEnv* env, jclass jcls,
...
int Java_org_copper_rat_CopperRat_nativeRemoveJoystick(
...
/* Surface Created */
void Java_org_copper_rat_CopperRat_onNativeSurfaceChanged(JNIEnv* env, jclass jcls)
{
    SDL_WindowData *data;
...
/* Surface Destroyed */
void Java_org_copper_rat_CopperRat_onNativeSurfaceDestroyed(JNIEnv* env, jclass jcls)
{
...
void Java_org_copper_rat_CopperRat_nativeFlipBuffers(JNIEnv* env, jclass jcls)
{
    SDL_GL_SwapWindow(Android_Window);
}

/* Keydown */
void Java_org_copper_rat_CopperRat_onNativeKeyDown(
...
/* Keyup */
void Java_org_copper_rat_CopperRat_onNativeKeyUp(
                                    JNIEnv* env, jclass jcls, jint keycode)
{
...
/* Keyboard Focus Lost */
void Java_org_copper_rat_CopperRat_onNativeKeyboardFocusLost(
                                    JNIEnv* env, jclass jcls)
{
...
/* Touch */
void Java_org_copper_rat_CopperRat_onNativeTouch(
                                    JNIEnv* env, jclass jcls,
...
/* Accelerometer */
void Java_org_copper_rat_CopperRat_onNativeAccel(
                                    JNIEnv* env, jclass jcls,
...
/* Low memory */
void Java_org_copper_rat_CopperRat_nativeLowMemory(
...
/* Quit */
void Java_org_copper_rat_CopperRat_nativeQuit(
                                    JNIEnv* env, jclass cls)
{
...
/* Pause */
void Java_org_copper_rat_CopperRat_nativePause(
                                    JNIEnv* env, jclass cls)
{
...
/* Resume */
void Java_org_copper_rat_CopperRat_nativeResume(
                                    JNIEnv* env, jclass cls)
{
...
void Java_org_copper_rat_SDLInputConnection_nativeCommitText(
                                    JNIEnv* env, jclass cls,
...
void Java_org_copper_rat_SDLInputConnection_nativeSetComposingText(
                                    JNIEnv* env, jclass cls,
                                    jstring text, jint newCursorPosition)
{
    const char *utftext = (*env)->GetStringUTFChars(env, text, NULL);
